...
const Contact = () => {
  return (
    <div className="w-full relative mx-auto h-screen p-10 flex justify-between items-center bg-gradient-to-r from-black via-gray-900 overflow-hidden">
      <div className="w-full lg:w-[45%]">
        <img src="Ella.jpg" alt="" className="w-[640px] h-[453px]" />
      </div>
      <div className="absolute -bottom-3 -right-3 w-full lg:w-[55%]">
        <h1 className="text-yellow-500 text-6xl mb-8">Contact me</h1>
        <div className=" border-4 border-yellow-400 p-10">
          <div className="flex">
            <div className="gap-6 py-5 px-10 flex flex-col">
              ...
              <input
                type="text"
                className="bg-transparent border-0 text-yellow-600 border-b-2 w-400 w-60"
              ></input>
            </div>
            <div className="p-10 flex flex-col gap-16">
              <div>
                <h2 className="text-2xl text-yellow-400">Contact</h2>
                <p>campbellemmanuella17@gmail.com</p>
              </div>
              <div>
